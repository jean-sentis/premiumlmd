...
Parle de CE lot précis, pas de sa catégorie en général. INTERDICTION de disserter sur « les masques africains », « les montres de gousset » ou « les huiles sur toile » comme un cours général : chaque phrase doit décrire l'objet que le lecteur a sous les yeux (ses caractéristiques probables, ce qui le distingue, ce qu'il faut y regarder concrètement). Bannis les tournures génériques du type « ces objets étaient conçus pour… », « ces masques servaient à… » : dis plutôt « ce masque… », « cette pièce… ».
Concentre-toi sur des angles NOUVEAUX et CONCRETS propres à ce lot, choisis parmi : les détails stylistiques ou techniques que l'on attend précisément sur cet objet (ce qu'un connaisseur y examine concrètement), le savoir-faire ou le contexte de production qu'il suppose, son usage ou sa fonction réelle, ce qui le rend remarquable ou rare, à quel type d'amateur ou d'intérieur il s'adresse. Chaque phrase doit dire quelque chose de vérifiable ou d'informatif SUR CE LOT.
INTERDICTION FORMELLE des phrases vagues, décoratives ou émotionnelles qui ne disent rien de concret (par ex. « offre une fenêtre sur la perception », « invite à l'immersion », « suscite une résonance émotionnelle », « la peinture à l'huile permet une richesse de textures », « témoigne d'une période de création »). Si tu n'as rien de concret à dire, cite un point d'analyse technique ou stylistique précis plutôt qu'une formule creuse.
Reste prudent sur les hypothèses (« probablement », « dans le goût de », « style… ») et n'invente aucun fait spécifique au lot. Longueur : 3 à 5 phrases, pas davantage.
...
- S'il n'y a rien de tout cela : donne des PISTES CONCRÈTES et NOMMÉES plutôt que des généralités. Ne te contente jamais d'un cadre vague (« Afrique de l'Ouest », « design du XXe siècle ») : propose, avec prudence, les aires géographiques, peuples/ethnies, ateliers, styles et fourchettes d'époque précis auxquels ce type d'objet est habituellement rattaché (par ex., pour un masque ouest-africain : « évoque les productions Dan de Côte d'Ivoire et du Liberia, ou les masques Baoulé et Sénoufo », « probablement première moitié / milieu du XXe siècle »). Encadre toujours ces pistes par des formules prudentes (« évoque », « rappelle », « dans le goût de », « souvent daté de ») puisque le lot ne les affirme pas — mais NOMME-les au lieu de rester dans le flou.
TON : écris pour un amateur d'art et de décoration qui cherche un supplément d'âme, PAS pour un colloque universitaire. Pas de jargon académique, pas de tournures pontifiantes (« cosmogonie », « vecteur de communication avec le monde invisible », « intrinsèquement lié »). Sois vivant, clair et incarné : ce qui rend l'objet attachant, ce qu'il raconte, l'image mentale qu'il fait naître, tout en restant factuel.
Reste factuel et prudent ; n'invente aucune attribution catégorique non suggérée par le lot (les pistes nommées restent des hypothèses signalées comme telles). Longueur : 3 à 5 phrases, pas davantage.
